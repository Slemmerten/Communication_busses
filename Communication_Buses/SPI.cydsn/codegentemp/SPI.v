...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("a27c9c31-36ea-4d6e-9d66-9b17aa8e8a04"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("b50164d5-98a9-466c-b834-5c68343081ec"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__ss_pin_net;
	wire [0:0] tmpFB_0__ss_pin_net;
	wire [0:0] tmpIO_0__ss_pin_net;
	wire [0:0] tmpINTERRUPT_0__ss_pin_net;
	electrical [0:0] tmpSIOVREF__ss_pin_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		ss_pin
		 (.oe(tmpOE__ss_pin_net),
		  .y({Net_34}),
		  .fb({tmpFB_0__ss_pin_net[0:0]}),
		  .io({tmpIO_0__ss_pin_net[0:0]}),
		  .siovref(tmpSIOVREF__ss_pin_net),
		  .interrupt({tmpINTERRUPT_0__ss_pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ss_pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
